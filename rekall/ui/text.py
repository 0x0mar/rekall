    ...
    def rebuild(self):
        ...
        if adjustment and self.mode == "stretch":
            ...
            if align == "l":
                ...
                self.cells[-1].rewrap(
                    width=(adjustment / 2) + self.cells[-1].width + adjust % 2)
                self.cells[0].rewrap(
    ...
    def rebuild(self):
        ...
        for cell in self.cells:
            ...
            if target_width:
                ...
                cell.rewrap(align=self.align, width=target_width,
                            mode="margin")
            else:
...
class Cell(BaseCell):
    ...
    def rewrap(self, width=None, align=None, **kwargs):
        super(Cell, self).rewrap(width=width, align=align, **kwargs)
